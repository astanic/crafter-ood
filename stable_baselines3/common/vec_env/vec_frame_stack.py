...
class VecFrameStack(VecEnvWrapper):
    ...
    def __init__(self, venv: VecEnv, n_stack: int, n_skip: int, channels_order: Optional[Union[str, Dict[str, str]]] = None):
        self.venv = venv
        ...
        if isinstance(wrapped_obs_space, spaces.Box):
            ...
            # self.stackedobs = StackedObservations(venv.num_envs, n_stack, n_skip, wrapped_obs_space, channels_order)
